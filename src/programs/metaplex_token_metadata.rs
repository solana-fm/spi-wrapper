...
pub const METAPLEX_DEPRECATED_MINT_NEW_EDITION_FROM_MASTER_VIA_EDITION_PRINTING_TOKEN_TABLE: &str = "metaplex_deprecated_mint_new_edition_from_master_edition_via_printing_tokens";
pub const METAPLEX_MINTED_NEW_EDITION_FROM_MASTER_EDITION_VIA_PRINTING_TOKEN_TABLE: &str = "metaplex_new_edition_from_master_edition_via_printing_tokens";

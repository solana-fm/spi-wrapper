...
use solana_sdk::{ precompiles::PrecompileError, secp256k1_instruction::{
...
pub async fn fragment_instruction(
    ...
    if instruction.data.len() < expected_data_size {
        ...
        found -> PrecompileError::InvalidInstructionDataSize"
        );
    ...
    for i in 0..count {
        ...
        //         info!(
        //             "[spi-wrapper/programs/native_secp256k1] INFO: On-chain failed instruction \
        // found because the signature's slice cannot be parsed. -> PrecompileError::InvalidSignature"
        //         );
        //         return Some(interpreted_instruction_set)
        //     }
        ...
        //
        //     let pubkey_result: Result<PublicKey, PrecompileError> = libsecp256k1::recover(
        ...
        //         info!(
        //             "[spi-wrapper/programs/native_secp256k1] INFO: On-chain failed instruction \
        // found because the pubkey's slice cannot be parsed. -> PrecompileError::InvalidSignature"
        //         );
        //         return Some(interpreted_instruction_set)
        //     }
